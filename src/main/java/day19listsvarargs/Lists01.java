...
public class Lists01 {
    public static void main(String[] args) {
        //Example1: Verilen bir List'teki elemanlari tekrarsiz olarak yazdiriniz.
        //          [2, 3, 2, 2, 3, 5] ==> [2, 3, 5]
        ...
        /*
        "for loop" kurunuz, products listindeki herbir elemanin tum characterlerini "set method"
        kullanarak kucuk harfe ceviriniz kullanicidan gelen urun ismini de kucuk harfle cevirin
         */
        ...
        do{
            ...
            }else if (!products.contains(p + " is in stock ")){
