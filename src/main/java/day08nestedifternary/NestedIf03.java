...
public class NestedIf03 {
    public static void main(String[] args) {
        /*
        Password'un ilk harfi buyuk harf ise 'A' olursa "gecerli password" yazdirin degilse "gecersiz password" yazdirin
        Alemci ==> Gecerli
        ...
        if(firstChar>='A' && firstChar<='Z'){
            ...
            if(firstChar=='z'){
                ...
                System.out.println("Gecersuz Password cunku harf ama 'z' degil...");
            }
        }else{
