...
public class OnlineAlisveris {
    ...
    private static void musteriSecim() {
        ...
        double urunTutari= adet*urunFiyatlari.get(secim-1);//get() index ile calistigi icin secim -1 yapariz
    ...
    private static void odeme() {
        ...
        if(date.isEqual(kurulusGunu)){
            System.out.println("Bugun bizim acilis yildonumumuz Borcunuz yoktur");
        }else
