...
public class Ternary01 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //Example3: Iki sayinin isareti ayni ise bu sayilari carpan, isaretleri farkli ise
        ...
        Object r3 = (m>0 && n>0) ||  (m<0 && n<0) ? m*n : "Farli isaretli sayilari carpamiyorum";
        System.out.println(r3);

        //Example4: Size verilen sayinin 3 basamakli olup olmadigini kontrol eden kodu yaziniz.
        int p = -436;
        int r = Math.abs(p);
