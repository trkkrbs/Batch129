...
public class IncrementDecrement01 {
    ...
    public static void main(String[] args) {
        ...
        //Example1: Bir tane integer variable olusturun ve onu iki sekilde 5 artirin.
        ...
        System.out.println(k);//10 ==> "i" satir sonunda artirildigi icin "i" nin degeri 11 olur.

        int m = 15;
        int n = ++m;// pre-increment cunku increment, variable'in isminden once yazildi

        System.out.println(m);//16 ==> "mM satir sonunda artirildigi icin "m" nin degeri 16 olur.
